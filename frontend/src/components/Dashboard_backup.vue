          ...
          <div class="content-card">
            ...
            <div class="card-content">
              <div class="quick-actions">
                ...
                <button class="quick-action-btn" @click="setCurrentView('exercise')">
                  <span class="action-icon">🏃‍♂️</span>
                  <span class="action-text">运动记录</span>
                </button>
                <button class="quick-action-btn" @click="setCurrentView('diet')">
                  <span class="action-icon">🍽️</span>
                  <span class="action-text">饮食记录</span>
                </button>
                <button class="quick-action-btn" @click="setCurrentView('overview')">
                  <span class="action-icon">�</span>
